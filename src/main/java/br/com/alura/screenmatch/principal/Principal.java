...
public class Principal {
    ...
    private void buscarPorMaxTemporadasEAvaliacao() {
        ...
        System.out.println("Avaliações a partir de qual valor?: ");
        var avaliacao = leitura.nextDouble();
        List<Serie> seriesEncontradas = repositorio.seriesPorTemporadaEAvaliacao(maxTemporadas,avaliacao);
        System.out.println("Séries com no maxímo " + maxTemporadas + " temporadas e avaliação acima de " + avaliacao);
        System.out.println("---------------------------------------------------------");
        seriesEncontradas.forEach(s ->
